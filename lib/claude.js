...
export async function analyzeStory({ title, fullText, prior, guide, eroticaLean, arc, sections }) {
  ...
  const system = [
    ...
    `Use exactly these keys, IN THIS ORDER (all strings except qualityScore): style, genre, synopsis, quality, qualityScore, critique, nextDirection, suggestions, ${hasArc ? "arcProgress, arcDone, " : ""}continuity.`,
    guide
