...
export async function reviseChunk({
  ...
  const system = [
    ...
    "Keep it recognizably the SAME story (same premise and central characters), but you MAY change events, scenes, order, and structure where the plan or the story calls for it. Be bold — transform weak material rather than rephrasing it.",
